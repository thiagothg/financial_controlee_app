...
/// Does not include colors, check [AppTheme] file for that.
...
class Insets {
  ...
  // Offset, used for the edge of the window, 
  //or to separate large sections in the app
...
class Shadows {
  ...
  static List<BoxShadow> get small => [
    BoxShadow(
      color: Color(0xff333333).withOpacity(.15), 
      spreadRadius: 0, blurRadius: 3, offset: Offset(0, 1)
      ),
  ];
}
...
/// this is uses by the TextStyles class to create concrete styles.
class Fonts {
...
/// Don't try and create every variant in existence here, 
